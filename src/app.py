...
apply, recharge, pending, test = filter_records(records)

apply.to_csv("../data/apply.csv", index=False)
recharge.to_csv("../data/recharge.csv", index=False)
pending.to_csv("../data/pending.csv", index=False)
test.to_csv("../data/test.csv", index=False)

# apply_df = pd.read_csv("../data/apply.csv")
# recharge_df = pd.read_csv("../data/recharge.csv")
# pending_df = pd.read_csv("../data/pending.csv")
# test_df = pd.read_csv("../data/test.csv")

print(apply.to_string())
print(recharge.to_string())
print(pending.to_string())
print(test.to_string())


# records.to_csv("../data/raw_records.csv", index=False)
